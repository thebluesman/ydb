...
- [0010 — Balance semantics are out of scope for chat SQL, enforced on the result label](0010-balance-semantics-enforced-on-result-label.md) — supersedes 0009; balance/net-worth questions still declined, but the route rejects balance-claiming result aliases rather than only `openingBalance`
