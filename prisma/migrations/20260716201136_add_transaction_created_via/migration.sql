...
INSERT INTO "new_Transaction" ("accountId", "amount", "category", "createdAt", "date", "description", "id", "linkedTransferId", "notes", "originalDescription", "parentTransactionId", "rawSource", "reimbursableFor", "reimbursementTxId", "status", "transactionType", "transferCounterpartAccountId", "updatedAt") SELECT "accountId", "amount", "category", "createdAt", "date", "description", "id", "linkedTransferId", "notes", "originalDescription", "parentTransactionId", "rawSource", "reimbursableFor", "reimbursementTxId", "status", "transactionType", "transferCounterpartAccountId", "updatedAt" FROM "Transaction";
