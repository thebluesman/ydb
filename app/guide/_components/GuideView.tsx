...
function FlowDiagram() {
  const steps = [
    { icon: <Upload size={20} />, label: 'Upload', sub: 'PDF statement' },
    { icon: <ScanText size={20} />, label: 'Extract', sub: 'Qwen reads it' },
    { icon: <CheckCircle size={20} />, label: 'Review', sub: 'Edit & commit' },
    { icon: <LayoutDashboard size={20} />, label: 'Insights', sub: 'Dashboard' },
  ]
  return (
...
function ChatFlowDiagram() {
  const steps = [
    { icon: <MessageCircle size={20} />, label: 'Question', sub: 'Plain English' },
    { icon: <FileCode2 size={20} />,     label: 'SQL',      sub: 'Generated by AI' },
    { icon: <Database size={20} />,      label: 'Query',    sub: 'Run on SQLite' },
    { icon: <TextQuote size={20} />,     label: 'Answer',   sub: 'Narrated back' },
  ]
  return (
        ...
        <div className="flex gap-12 items-start">
          ...
          <div className="flex-1 min-w-0 space-y-16">
            ...
            <Section id="ledger" num="04" title="The Ledger">
              ...
              <BodyText>
                Click the <Download size={14} style={{ display: 'inline', verticalAlign: 'middle' }} />{' '}
            ...
            <Section id="settings" num="12" title="Settings">
              ...
              <Tip>
                <AlertTriangle size={14} style={{ display: 'inline', verticalAlign: 'middle', marginRight: 4, color: '#f54e00' }} />
