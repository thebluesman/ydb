...
export function TransferLinkModal({
  ...
  return (
    <Modal open onClose={onClose} title="Link Transfer" maxWidth={520}>
        ...
        <div className="space-y-1">
          {shown.map((t) => (
            ...
            >
              ...
              <span className="text-xs amount mr-3 whitespace-nowrap" style={{ color: t.amount < 0 ? 'var(--tx-error)' : 'var(--tx-success)' }}>
